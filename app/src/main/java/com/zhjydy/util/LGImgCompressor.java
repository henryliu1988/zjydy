...
public class LGImgCompressor {
    ...
    public static LGImgCompressor getInstance() {
        if (instance == null) {
            synchronized (LGImgCompressor.class) {
                if (instance == null)
                    instance = new LGImgCompressor(zhjApplication.getInstance().getContext());
            }
        }
        return instance;
    }
     ...
     * @param srcImagePath     原始图片的String
    ...
    public CompressResult compressSync(String srcImagePath,int outWidth,int outHeight,int maxFileSize) {
        CompressResult compressResult = new CompressResult();
        String outPutPath = null;
        try {
            outPutPath = compressImage(srcImagePath, outWidth, outHeight, maxFileSize);
        }catch (Exception e){
        }
        compressResult.setSrcPath(srcImagePath);
